                            ...
                            <div class="container-fluid">
                                ...
                                <form action="/customer/login" method="POST">
                                    ...
                                    <div class="form-group step-username">
                                        <label for="username" class="form-label font-18">شماره موبایل</label>
                                        <input type="text" name="phone_number" id="phone_number" placeholder="شماره تلفن خود را وارد کنید" class="form-control py-4">
                                    </div>
