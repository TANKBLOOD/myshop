...
@section('mainContent')
    <div class="card p-4 bg-white" dir="rtl">

        <form id="createProductForm" action="" enctype="multipart/form-data" style="text-align: right;">
            @csrf
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-12 form-group">
                        ...
                        <textarea name="content" id="mainContent">{!! old('content', $product->content) !!}</textarea>
                    ...
                    @foreach ($productSpecifications as $specification)
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" id="brand" class="form-control"
                                data-persian="{{ $specification->title }}" onchange="onProductSpecificationChange(this)"
...
@section('exclusiveScripts')
        ...
        tinymce.init({
            ...
            setup: function(editor) {
                editor.on('init', function() {
                    this.setContent(`{!! addslashes($product->content) !!}`);
                });
            }
        });
    </script>
    ...
    <script>
        ...
        $("#createProductForm").submit(function(event) {
            ...
            let editorContent = tinymce.get('mainContent').getContent();

            const form = document.getElementById('createProductForm');
            var formData = new FormData(form);

            formData.append('content', editorContent); // Append TinyMCE content explicitly
        ...
        console.log("conetnt", @json($product->content))
    </script>
@endsection
