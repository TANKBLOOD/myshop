...
const UserNavigation = () => {
  ...
  return (
    <nav>
      {flags.searchRedirect === true ? <Navigate to="/product/search" /> : null}
      <div
        className="container"
        style={{
          direction: "rtl",
      ...
      >
        ...
        <div className="navigation navigation-top clearfix">
          <ul>
            ...
            <li>
              <a className="open-search" onClick={handleSearchBar}>
                    ...
                    <div className="box-sm">
                      ...
                      <div className="box">
                        ...
                        <div className="clearfix">
                          <p>
                            خانه هایی که از نظر سبک ، مفهوم و راه حل های معماری
                            متفاوت هستند ، توسط کارخانه مبلمان ارائه شده اند.
                            این فضاها از یک سبک زندگی بین المللی حکایت دارد که
                            بیانگر مدرنیته ، تحقیقات و روحیه ای خلاق است.
                          </p>
                          <a
        ...
        <div
          className={`search-wrapper ${flags.searchBar === true ? "open" : ""}`}
          style={{
            display: "block",
          }}
        >
